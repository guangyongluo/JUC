...
import com.vilin.juc.utils.threadpool.BasicThreadPool;
import com.vilin.juc.utils.threadpool.RunnableDenyException;
import com.vilin.juc.utils.threadpool.ThreadPool;
...
public class ChatServer {
    ...
    public void startServer() throws IOException, RunnableDenyException {
    ...
    private void listen() throws IOException, RunnableDenyException {
        for (; ; ) {
            //accept 方法是阻塞方法，当有新的连接进入时才会返回，并且返回的是客户端的连接
            Socket client = serverSocket.accept();
            //将客户端连接作为一个Request封装对应的Handler然后提交给线程池
