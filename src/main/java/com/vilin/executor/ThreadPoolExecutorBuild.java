...
public class ThreadPoolExecutorBuild {
     ...
     * Testing point.
     *
     * 1.coreSize = 1, MaxSize = 2，blockingQueue is empty what happen when submit three tasks?
     * 2.coreSize = 1, MaxSize = 2, blockingQueue size = 5 what happen when submit 7 tasks?
     * 3.coreSize = 1, MaxSize = 2, blockingQueue size = 5 what happen when submit 8 tasks?
     */
